$(function(e) {
    ...
    // console.log('sdgijsdfgjdfdfguedtgj');

    $(document).on('submit', '#register', function() {
        if ($(this).is_valid()) {
            if ($('input[name=termcondition]:checked').length) {
    ...
    (function($) {
        ...
        $(window).on("load", function() {
            ...
            console.log('sdkgjf', $('.' + urlHash).offset().top);
        });
